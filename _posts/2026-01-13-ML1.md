...
2. [Python and Machine Learning Basics](###2.-python-and-machine-learning-basics)
3. [The Dataset](###3.-the-dataset)
4. [Complete Pipeline: From Data to Trained Model](###4.-complete-pipeline-from-data-to-trained-model)
...
### 2. Python & Machine Learning: From Absolute Zero
