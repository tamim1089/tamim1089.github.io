...
1. Viega, J., & Messier, M. (2003). *Secure Programming Cookbook for C and C++*. O'Reilly Media. Available at: [https://www.oreilly.com/library/view/secure-programming-cookbook/0596003943/](https://www.oreilly.com/library/view/secure-programming-cookbook/0596003943/)

2. OWASP. (n.d.). *Buffer Overflow via Environment Variables*. Available at: [https://owasp.org/www-community/attacks/Buffer_Overflow_via_Environment_Variables](https://owasp.org/www-community/attacks/Buffer_Overflow_via_Environment_Variables)

3. SEI CERT. (n.d.). *ENV03-C: Sanitize the environment when invoking external programs*. CERT C Coding Standard. Available at: [https://wiki.sei.cmu.edu/confluence/display/c/ENV03-C.%2BSanitize%2Bthe%2Benvironment%2Bwhen%2Binvoking%2Bexternal%2Bprograms](https://wiki.sei.cmu.edu/confluence/display/c/ENV03-C.%2BSanitize%2Bthe%2Benvironment%2Bwhen%2Binvoking%2Bexternal%2Bprograms)

4. MITRE. (n.d.). *CAPEC-10: Buffer Overflow via Environment Variables*. Available at: [https://capec.mitre.org/data/definitions/10.html](https://capec.mitre.org/data/definitions/10.html)

5. Pentester Academy. (2018). *Premium Lab - Buffer Overflow via Environment Variables*. Available at: [https://blog.pentesteracademy.com/premium-lab-buffer-overflow-environment-variables-d03a85ee776d](https://blog.pentesteracademy.com/premium-lab-buffer-overflow-environment-variables-d03a85ee776d)

6. Stack Overflow. (2013). *Standard C Usage of getenv() and Safe Practices*. Available at: [https://stackoverflow.com/questions/15034723/standard-c-usage-of-getenv-and-safe-practices](https://stackoverflow.com/questions/15034723/standard-c-usage-of-getenv-and-safe-practices)
