...
_Figure 5. Change in task completion time with AI in METR's 2025 study: what economists, ML experts and the developers predicted, what the developers believed afterwards, and what was measured, with its confidence interval. Data from [\[44\]](#ref-44)._
...
_Figure 6. A schematic of Bainbridge's argument, not data. Before automation, the frequent routine work is also practice for the rare failure. After it, the rare failure is the only practice left._
...
Programming isn't the first field to hand a core skill to a machine, and the other fields already have data.

Medicine has the cleanest recent example. At four endoscopy centres in Poland that started using AI to spot polyps during colonoscopy, researchers compared the doctors' ordinary colonoscopies, the ones done without the AI, in the 3 months before and the 3 months after it arrived [\[54\]](#ref-54). Across 1443 patients, the rate at which doctors found adenomas without the AI fell from 28.4% to 22.4%. It's observational, the window is short, and something else could have changed in those months, so I wouldn't lean on the exact number. But it's the Bainbridge pattern in a hospital: people who got used to the machine pointing at the polyp got worse at finding polyps when the machine wasn't there.

Navigation shows the slow version. Dahmani and Bohbot measured 50 regular drivers and found that the ones with more lifetime GPS use had worse spatial memory when they had to find their way without it [\[55\]](#ref-55). They retested 13 of them three years later, and more GPS use in between went with a steeper decline. The part I find most useful is that the heavy users didn't say they used GPS because they had a bad sense of direction, which makes "people who were already bad at it used it more" a weaker explanation. The small follow-up sample is a real limit.

And then there's the counterexample, and I think it matters more than the other two. In 1986 Hembree and Dessart pooled 79 research reports on calculators in school maths, back when everyone was sure calculators would ruin arithmetic [\[56\]](#ref-56). Except in grade four, calculators used together with normal instruction improved average students' paper-and-pencil skills. The panic was wrong.

Put the three next to each other and the difference isn't the tool, it's whether the practice continued. The endoscopists stopped doing the searching themselves. The GPS drivers stopped building maps. The calculator students kept doing paper arithmetic in class, and the calculator took the tedious part around it. That's the same line I drew with Kapur and worked examples, just in three fields that have nothing to do with code. So my claim for programming is concrete: AI assistance will deskill exactly the operations people stop practising, and leave alone the ones they keep doing next to it. Which operations those are is a choice teams and courses make, mostly without noticing they made it.

## How much code a team can know

Software can grow faster than the people maintaining it can take in. Meir Lehman saw this in large systems that had been evolving for years. One of his laws of software evolution, conservation of familiarity, says the content of successive releases stays statistically invariant, because every release forces the people working on the system to get familiar with it again, with effort growing at least quadratically with the size of the release [\[57\]](#ref-57). The next part is mine, not Lehman's: growth works against familiarity unless the organization pays for learning, restructuring, documentation or specialization.

Brooks separated essential from accidental difficulty [\[58\]](#ref-58). Better tools remove accidental work: syntax, boilerplate, search, repetitive implementation. The essential difficulty is, in his words, "the specification, design, and testing of this conceptual construct, not the labor of representing it", and tools don't remove that. Code generation is a very good tool for the labor of representing. Which means it speeds up exactly the part that was never the bottleneck, and floods the part that was.
...
_Figure 7. The level in the tub is code nobody on the team understands yet. It rises whenever generation outpaces assimilation, however fast either one is._
...
54. <span id="ref-54"></span>K. Budzyń et al., "Endoscopist deskilling risk after exposure to artificial intelligence in colonoscopy: a multicentre, observational study," *Lancet Gastroenterology and Hepatology* 10(10), 2025. <https://doi.org/10.1016/S2468-1253(25)00133-5>
55. <span id="ref-55"></span>L. Dahmani and V. D. Bohbot, "Habitual use of GPS negatively impacts spatial memory during self-guided navigation," *Scientific Reports* 10, 2020. <https://doi.org/10.1038/s41598-020-62877-0>
56. <span id="ref-56"></span>R. Hembree and D. J. Dessart, "Effects of hand-held calculators in precollege mathematics education: a meta-analysis," *Journal for Research in Mathematics Education* 17(2), 1986. <https://doi.org/10.2307/749255>
57. <span id="ref-57"></span>M. M. Lehman, "On understanding laws, evolution, and conservation in the large-program life cycle," *Journal of Systems and Software* 1, 1980. <https://doi.org/10.1016/0164-1212(79)90022-0>
58. <span id="ref-58"></span>F. P. Brooks, "No silver bullet: essence and accidents of software engineering," *Proc. IFIP Congress*, 1986, reprinted in *IEEE Computer* 20(4), 1987. Link is the IFIP text. <https://worrydream.com/refs/Brooks-NoSilverBullet.pdf>
